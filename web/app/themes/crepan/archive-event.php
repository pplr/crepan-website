  ...
  <div class="row">
	...
	<h1 class="page-title">
	  <?php
	     ...
	     echo 'Événements du '.eo_get_event_archive_date('j F Y');
	     elseif( eo_is_event_archive('month') )
	     //Viewing month archive
	     echo 'Événements de '.eo_get_event_archive_date('F Y');
	     elseif( eo_is_event_archive('year') )
	     //Viewing year archive
	     echo 'Évènements de l’année '.eo_get_event_archive_date('Y');
	     else
